#p0030randnumbers.rb
=begin
  if you call rand, you will get a float grater than or equal to 0.0
and less than 1.0, if you give it  an integer parameter(by calling rand(5)),
you will get an integer value grater than or equal to 0 and less than 5
=end
#This program below makes three lists of words and then randmonly pick one word from 
#each of the three lists and prints out the result
